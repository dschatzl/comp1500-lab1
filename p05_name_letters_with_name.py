...
# For example, if the user says that their name is "mimir" then your program
# should print 'mimir has 5 letters'

# Note that this is the same as the previous problem except that instead of
# printing 'Your name' you must print out the name that the user entered.
